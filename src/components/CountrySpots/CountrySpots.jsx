...
const CountrySpots = () => {
    ...
    return (
        <div className="mb-12">
            <Helmet>
                <title>Country Spots | Tripster</title>
            </Helmet>
            <div className="h-[400px] relative">
                ...
                <div className="z-10 w-full absolute left-1/2 top-[22%] sm:top-[35%] -translate-x-1/2">
                    <h1 className="font-kaushan w-full text-center sm:text-5xl text-3xl font-bold text-[#e2e2e2]">Country Spots</h1>
            ...
            <div className="mt-5 max-w-[1480px] mx-auto px-3">
                <div className="grid md-lg:grid-cols-3 grid-cols-1 sm:grid-cols-2 gap-y-7 gap-x-5">
                    {
                        countrySpots.map(countrySpot => <CountrySpot countrySpot={countrySpot} key={countrySpot._id}></CountrySpot>)
                    }

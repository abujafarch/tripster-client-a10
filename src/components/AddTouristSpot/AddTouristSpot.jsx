            ...
            <div className="max-w-[1200px] mx-auto">
                <form className="mx-5 relative px-3 p-5 rounded-md bg-white -top-24">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                        ...
                        <div >
                            <p className="text-lg mb-1 font-macondo font-semibold text-dark-blue">User Email</p>
                            <input type="email" className="pr-2 font-semibold text-lg font-macondo w-full pl-1 py-2 rounded-sm outline-none border-2 border-dark-blue" placeholder="User Email" />
                        </div>
                        <div >
                            <p className="text-lg mb-1 font-macondo font-semibold text-dark-blue">User Name</p>
                            <input type="text" className="pr-2 font-semibold text-lg font-macondo w-full pl-1 py-2 rounded-sm outline-none border-2 border-dark-blue" placeholder="User Name" />
                        </div>
                    </div>
                    <div className="mt-8">
                    ...
                    <button className="py-2 w-full text-center text-white text-lg font-semibold font-macondo my-10 px-4 bg-dark-blue">Add</button>
                </form>
            </div>
        </div>
    );

...
const Login = () => {
    ...
    return (
        <div className="mt-[170px] md-lg:mx-auto mx-5 shadow-my-shadow rounded-xl h-[500px] w-fit mx-auto items-center flex gap-2 justify-center">
            {/* <Helmet>
                <title>Login | Utopia</title>
            </Helmet> */}

            <div className="max-w-[430px] w-1/2">
                <LoginBanner></LoginBanner>
            </div>
            <div className="rounded-xl h-fit md-lg:min-w-[430px] w-1/2">
                <h4 className="text-5xl mb-2 font-poppins text-light-blue font-semibold text-center">Welcome</h4>

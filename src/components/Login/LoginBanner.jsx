                ...
                <SwiperSlide className="w-full">
                    <div className=" h-[500px] w-full object-cover relative">
                        ...
                        <div className="absolute top-16 z-20 text-white text-center">
                            ...
                            <p className="font-macondo p-10 pt-0 font-medium">Explore Bangladesh's stunning nature: Sundarbans, Sylhet tea gardens, Padma river, and diverse wildlife. Nature enthusiasts' dream destination</p>
                        </div>
                    </div>
                </SwiperSlide>
                <SwiperSlide className="w-full ">
                    <div className=" h-[500px] w-full object-cover relative">
                        ...
                        <div className="absolute top-16 z-20 text-white text-center">
                            ...
                            <p className="font-macondo p-10 pt-0 font-medium">Thailand, known for its vibrant culture, stunning beaches, rich history, and delicious cuisine, offers travelers a truly unforgettable experience.</p>
                        </div>
                    </div>
                </SwiperSlide>
                <SwiperSlide className="w-full">
                    <div className="h-[500px] w-full object-cover relative">
                        ...
                        <div className="absolute top-16 z-20 text-white text-center">
                            ...
                            <p className="font-macondo p-10 pt-0 font-medium">
                ...
                <SwiperSlide className="w-full">
                    <div className="h-[500px] w-full object-cover relative">
                        ...
                        <div className="absolute top-16 z-20 text-white text-center">
                            ...
                            <p className="font-macondo p-10 pt-0 font-medium">Vietnam, with its captivating landscapes, rich history, vibrant cities, and delicious cuisine, promises travelers an unforgettable journey filled with cultural immersion and natural beauty.</p>
                        </div>
                    </div>
                </SwiperSlide>
                <SwiperSlide className="w-full">

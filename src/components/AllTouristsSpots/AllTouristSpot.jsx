    ...
    return (
        <div className="border border-[#dadada]">
            <div className="relative">
                <img className="h-[300px] object-cover object-center" src="https://i.ibb.co/CPkhyJJ/vietnam-f.jpg" />
            ...
            <Link to='/view-details'><button className="py-2 px-5 bg-light-blue rounded-sm text-white font-macondo text-lg ml-2 mb-3">View Details</button></Link>
        </div>
    );
};

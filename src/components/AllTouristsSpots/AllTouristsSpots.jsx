        ...
        <div className="mb-12">
            ...
            <div className="h-[400px] relative">
                ...
                <div className="z-10 w-full absolute left-1/2 top-[22%] sm:top-[35%] -translate-x-1/2">
                    ...
                    <p className="text-[#e2e2e2] mt-4 sm:mt-8 max-w-[800px] mx-auto px-2 font-inter text-lg text-center">Asia, the world's largest continent, is a treasure trove of diversity. From the majestic Himalayas to the serene beaches of Southeast Asia, it offers iconic landmarks, rich cultures, and breathtaking natural beauty</p>
                </div>
